...
def get_fallback_task(cls, topic):
    ...
    task_dict = {
        ...
        "давление": f"УСЛОВИЕ: Трактор массой 2000 кг, площадь гусениц 4 м². Определите давление на дорогу. g = 10 Н/кг.\nМОЁ РЕШЕНИЕ:\n1) p — давление.\n2) F = m*g, p = F/S.\n3) p = 20000 / 4 = 5000 Па.\nОТВЕТ: 5000 Па.",
        ...
        # 10 класс
        "тяготение": f"УСЛОВИЕ: Найдите силу притяжения между Землёй и человеком массой 70 кг на поверхности Земли.\nМОЁ РЕШЕНИЕ:\n1) F = mg.\n2) F = 70 * 10 = 700 Н.\nОТВЕТ: 700 Н.",
