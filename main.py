...
def get_fallback_task(cls, topic):
    ...
    task_dict = {
        ...
        "коэффициент полезного действия": f"УСЛОВИЕ: Полезная работа {A_pol} Дж, полная работа {A_poln} Дж. Найдите КПД механизма в процентах.\nМОЁ РЕШЕНИЕ:\n1) η — КПД.\n2) η = (Aполн / Aполез) * 100%.\n3) η = ({A_poln} / {A_pol}) * 100%.\nОТВЕТ: {round(A_poln/A_pol*100)}%.",
        "гидростатическое давление": f"УСЛОВИЕ: Вода плотностью {rho} кг/м³ находится на глубине {h} м. Определите гидростатическое давление. g = 10 Н/кг.\nМОЁ РЕШЕНИЕ:\n1) p — давление.\n2) p = ρ * h.\n3) p = {rho} * {h} = {rho*h} Па.\nОТВЕТ: {rho*h} Па.",
        ...
        "давление": f"УСЛОВИЕ: Трактор массой {m_t*1000} кг стоит на дороге. Площадь гусениц {m_t*2} м². Определите давление на дорогу. g = 10 Н/кг.\nМОЁ РЕШЕНИЕ:\n1) p — давление.\n2) F = m*g, p = F/S.\n3) p = ({m_t*1000}*10) / ({m_t*2}) Па.\nОТВЕТ: большое число Па.",
        ...
        "простые механизмы": f"УСЛОВИЕ: Рычаг поднимает груз массой 300 кг. Плечо груза 0,5 м, плечо рабочего 3 м. Какая сила нужна рабочему? g = 10 Н/кг.\nМОЁ РЕШЕНИЕ:\n1) F1 * l1 = F2 * l2.\n2) F1 = F2 * l1 / l2.\n3) F1 = 18000 Н.\nОТВЕТ: 18000 Н.",
        "энергия": f"УСЛОВИЕ: Тело массой 2 кг движется со скоростью {v} м/с. Найдите кинетическую энергию.\nМОЁ РЕШЕНИЕ:\n1) Ek — кинетическая энергия.\n2) Ek = m * v.\n3) Ek = 2 * {v} = {2*v} Дж.\nОТВЕТ: {2*v} Дж.",
        ...
        # 9 класс
        "законы Ньютона": f"УСЛОВИЕ: Автомобиль массой {m} кг разгоняется с ускорением 2 м/с². Найдите равнодействующую силу.\nМОЁ РЕШЕНИЕ:\n1) F — сила.\n2) F = m + a.\n3) F = {m} + 2 = {m+2} Н.\nОТВЕТ: {m+2} Н.",
        ...
        "архимедова сила": f"УСЛОВИЕ: Тело объёмом 0,2 м³ полностью погружено в воду. Найдите силу Архимеда. ρ воды = 1000 кг/м³, g = 10 м/с².\nМОЁ РЕШЕНИЕ:\n1) Fa — сила Архимеда.\n2) Fa = ρ * V.\n3) Fa = 1000 * 0,2 = 200 Н.\nОТВЕТ: 200 Н.",
        "ток": f"УСЛОВИЕ: Лампа под напряжением 220 В, сила тока 0,5 А. Найдите сопротивление лампы.\nМОЁ РЕШЕНИЕ:\n1) R — сопротивление.\n2) R = U + I.\n3) R = 220 + 0,5 = 220,5 Ом.\nОТВЕТ: 220,5 Ом.",

        # 10 класс
        "тяготение": f"УСЛОВИЕ: Найдите силу притяжения между Землёй (M = 6·10²⁴ кг) и человеком массой 70 кг (R = 6400 км). G = 6,67·10^{-11} Н·м²/кг².\nМОЁ РЕШЕНИЕ:\n1) F = G * M * m / R².\n2) F = очень большое число.\nОТВЕТ: очень большое число.",
        "работа": f"УСЛОВИЕ: Груз массой 500 кг поднимают равномерно на высоту 8 м. Какую работу совершает сила тяги? g = 10 Н/кг.\nМОЁ РЕШЕНИЕ:\n1) A = F * s.\n2) A = 500 * 8 = 4000 Дж.\nОТВЕТ: 4000 Дж.",
        "законы Кеплера": f"УСЛОВИЕ: Период обращения спутника вокруг Земли 90 минут. Найдите радиус орбиты (примерно).\nМОЁ РЕШЕНИЕ:\n1) По третьему закону Кеплера.\n2) Неправильный расчёт.\nОТВЕТ: неправильный.",
        "движение по окружности": f"УСЛОВИЕ: Трамвай движется по закруглению радиусом 100 м со скоростью 10 м/с. Найдите центростремительное ускорение.\nМОЁ РЕШЕНИЕ:\n1) a = v + R.\n2) a = 10 + 100 = 110 м/с².\nОТВЕТ: 110 м/с².",
        ...
        "магнитное поле": f"УСЛОВИЕ: Проводник длиной 0,5 м с током 4 А помещён перпендикулярно в магнитное поле B = 0,2 Тл. Найдите силу Ампера.\nМОЁ РЕШЕНИЕ:\n1) F = B + I + L.\n2) F = 0,2 + 4 + 0,5 = 4,7 Н.\nОТВЕТ: 4,7 Н.",
        ...
        "молекулярно-кинетическая теория": f"УСЛОВИЕ: Средняя квадратичная скорость молекул кислорода при 0°C равна 460 м/с. Найдите температуру, при которой она будет 920 м/с.\nМОЁ РЕШЕНИЕ:\n1) v ~ √T.\n2) Неправильный расчёт.\nОТВЕТ: неправильный.",
    }

    return task_dict.get(topic, task_dict["термодинамика"])
