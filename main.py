...
def get_fallback_task(cls, topic):
    ...
    task_dict = {
        ...
        # 10 класс
        "тяготение": f"УСЛОВИЕ: Найдите силу притяжения между Землёй и человеком массой 70 кг на поверхности. g = 10 Н/кг.\nМОЁ РЕШЕНИЕ:\n1) F = m * g.\n2) F = 70 * 10 = 700 Н.\nОТВЕТ: 700 Н.",
        "работа": f"УСЛОВИЕ: Груз массой 500 кг поднимают на высоту 8 м. Какую работу совершает сила тяги? g = 10 Н/кг.\nМОЁ РЕШЕНИЕ:\n1) A = F * s.\n2) A = 500 * 8 = 4000 Дж.\nОТВЕТ: 4000 Дж.",
        "законы Кеплера": f"УСЛОВИЕ: Спутник делает один оборот вокруг Земли за 90 минут. Примерно на какой высоте он находится?\nМОЁ РЕШЕНИЕ:\n1) По третьему закону Кеплера.\n2) Неправильный расчёт.\nОТВЕТ: неправильный.",
        ...
        "магнитное поле": f"УСЛОВИЕ: Проводник длиной 0,5 м с током 4 А в поле B = 0,2 Тл перпендикулярно. Найдите силу Ампера.\nМОЁ РЕШЕНИЕ:\n1) F = B + I + L.\n2) F = 0,2 + 4 + 0,5 = 4,7 Н.\nОТВЕТ: 4,7 Н.",
        "колебания": f"УСЛОВИЕ: Маятник длиной 1 м. Найдите период колебаний. g = 10 м/с².\nМОЁ РЕШЕНИЕ:\n1) T = 2π √l.\n2) T = 2 * 3,14 * 1 ≈ 6,28 с.\nОТВЕТ: 6,28 с.",
        "молекулярно-кинетическая теория": f"УСЛОВИЕ: Средняя квадратичная скорость молекул газа при 0°C равна 460 м/с. При какой температуре она станет 920 м/с?\nМОЁ РЕШЕНИЕ:\n1) v ~ √T.\n2) Неправильный расчёт.\nОТВЕТ: неправильный.",
    }
