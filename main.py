...
def get_student_response(user_message, session):
    ...
    prompt = (
        ...
        "6. Пиши как настоящий русский школьник — живо и разговорно. "
        "Никаких английских слов и никаких калек с английского. "
        "Плохо: «дёрнул проводом прямой длины», «в случае если», «является тем, что». "
        "Хорошо: «ну, рычаг же помогает», «мне кажется, так легче», «наверное, потому что».\n"
