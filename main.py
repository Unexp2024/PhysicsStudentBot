...
def get_student_response(user_message, session):
    ...
    # Разные инструкции в зависимости от количества объяснений
    if good_count == 0:
        # Учитель ещё не дал полезного объяснения (или только что дал первое)
        # Бот должен размышлять вслух, но не давать готовых формул
        instructions = (
            "Ты только что получил задачу и сделал грубую ошибку. Учитель дал тебе первый наводящий вопрос или объяснение.\n"
        ...
        # Первое объяснение уже было, сейчас второе
        instructions = (
